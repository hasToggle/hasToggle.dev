...
import GeneratingListItems from "./generating-list-items";

export function BentoCardWithState({
  dark = false,
  className = "",
  eyebrow,
  title,
  ...
  return (
    ...
    >
      <div className="relative h-80 shrink-0">
        <GeneratingListItems onSelect={handleSelection} />
        {fade.includes("top") && (
