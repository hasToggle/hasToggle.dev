...
/**
 * The fingerprint and the moment it was rendered — the two things that are
 * true of this cache entry no matter which render produced it. Where it came from is a
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="font-display font-medium text-4xl text-foreground tracking-tight sm:text-5xl">
        entry <BakeSwatch className="mr-1 align-[0.02em]" id={bake.id} />
      ...
      <dl className="grid gap-1 font-mono text-muted-foreground text-sm/6">
        <div className="flex gap-3">
          <dt className="w-16 shrink-0 text-muted-foreground">rendered</dt>
