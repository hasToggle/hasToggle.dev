 ...
 * squiggles it, and the compiler's first sentence as the note. The
 * excerpt is the function alone — the imports add height, not meaning,
 * and the drawer holds the whole file. The same
