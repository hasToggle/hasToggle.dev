...
// file it named never existed — the reference came in with the initial commit
// (and pointed at `scripts/skip-ci.js`, relative to each app's Root Directory,
// which is wrong twice over). Builds only ever proceeded because a missing
// file makes node exit 1, which Vercel reads as "build". That worked by
// accident.
//
